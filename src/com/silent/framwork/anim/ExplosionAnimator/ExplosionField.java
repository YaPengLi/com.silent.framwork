package com.silent.framwork.anim.ExplosionAnimator;
...
public class ExplosionField extends View {
	...
	public void explode(final View view) {
		...
		int startDelay = 100;
		ValueAnimator animator = ValueAnimator.ofFloat(new float[] { 0f, 1f })
				.setDuration(150);
		...
		explode(ExplosionUtils.createBitmapFromView(view), r, startDelay,
