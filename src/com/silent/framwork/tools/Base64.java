...
//        } else {
//            // 三星等部分设备修改了SDK的Base64，导致encode结果末尾会多�?�?0x0a（换行）
//            try {
...
//        if (Build.VERSION.SDK_INT < 8) { 
            ...
            try {
                ...
                Log.e("","Charset: " + charset + " not supported. Using default.");
                return new String(decode(data));
            }
//        } else {
//            try {
...
//            try {
//                Class<?> c = Class.forName("android.util.Base64");
//                byte byteData[] = ReflectUtils.invokeStatic(byte[].class, c, "decode", new Class[] { byte[].class,
//                        int.class }, new Object[] { data, c.getField("DEFAULT").get(c) });
//                return new String(byteData, charset);
//            } catch (Exception e) {
//                LogUtils.e(e);
